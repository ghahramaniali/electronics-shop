    ...
    <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <AnimatedSection animation="fade-up" delay={300}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div
            className="text-center p-6 rounded-xl bg-gradient-to-br from-surface to-surface/80 border border-light hover:shadow-xl hover:shadow-accent/10 transition-all duration-300 hover:border-accent/30 group"
